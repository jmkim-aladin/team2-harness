...
Use this skill when the user asks to run the migrated source command `ad-code-review`.
...
| `$YOUTRACK_TOKEN` | YouTrack KB/티켓 참조 | 개인 `~/.Codex/settings.json` |
| `$YOUTRACK_BASE_URL` | YouTrack 베이스 URL | 프로젝트 `.Codex/settings.json` |
