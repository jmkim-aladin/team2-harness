...
```
[DEV2-티켓번호] 요청 제목 또는 핵심 산출물 요약
```

- 예: `[DEV2-6654] 합산 구매내역 통계 요청`
- 예: `[DEV2-6807] 앱푸시 발송 리스트 쿼리 작성`
- `요청 완료`, `쿼리 작성`, `수정`처럼 단독으로 내용을 알 수 없는 범용 문구는 기본값으로 쓰지 않는다.
