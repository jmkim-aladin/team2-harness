...
상시 운영에서는 Hermes 자체 Docker 컨테이너 안의 `local` 실행 환경을 사용한다. team2 하네스 repo는 read-only로, vault는 draft 노트와 projection을 남길 수 있도록 read-write로, output 디렉터리는 read-write로 mount한다. Docker socket은 mount하지 않는다.
...
services:
  hermes-team2:
    ...
    volumes:
      ...
      - "/Users/jm/Library/Mobile Documents/iCloud~md~obsidian/Documents/team2:/workspace/team2-vault:rw"
...
docker run -it --rm \
  ...
  -v "/Users/jm/Library/Mobile Documents/iCloud~md~obsidian/Documents/team2:/workspace/team2-vault:rw" \
